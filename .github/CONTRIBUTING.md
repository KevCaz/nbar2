...
* Submit an issue on the [Issues page](https://github.com/KevCaz/nbar2/issues)
...
* Make sure to track progress upstream (i.e., on our version of `rcites` at `KevCaz/nbar2`) by doing `git remote add upstream https://github.com/KevCaz/nbar2.git`. Before making changes make sure to pull changes in from upstream by doing either `git fetch upstream` then merge later or `git pull upstream` to fetch and merge in one step
* Make your changes (bonus points for making changes on a new feature branch)
* Please do write a test(s) for your changes if they affect code and not just docs (see Tests below)
* Push up to your account
* Submit a pull request to home base at `KevCaz/nbar2`
